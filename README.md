[Solid](https://github.com/solid) is an initiative led by Tim Berners-Lee with the goal of decentralising power on the web to ensure that the web is used for the global public interest.

# Solid Specifications by the W3C Solid Community Group
...
## Developing the Solid Specifications
